...
/* === js/simulation/particle-system.js === */
...
/* === js/simulation/agglutination.js === */
...
/* === js/simulation/animation-loop.js === */
class AnimationLoop {
  constructor() {
    this.running = false;
    this.lastTime = 0;
...
/* === js/simulation/simulation-engine.js === */
...
/* === js/screens/simulator-screen.js === */
...
class QuizRenderer {
  ...
  renderFeedback({ isCorrect, correctAnswer, explanation, points, streak }) {
    ...
    feedback.innerHTML = `
      ...
      <p>${explanation}</p>
      <button id="btn-quiz-advance" class="btn btn--primary" style="margin-top:1rem;width:100%">Avançar →</button>
    `;
...
/* === js/screens/transfusion-screen.js === */
...
/* === js/screens/encyclopedia-screen.js === */
